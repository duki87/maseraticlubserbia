...
//print "^^";
    ...
    {
        if($this->has_title())
            return $this->caption->title->text;

        if($this->has_description())
            return $this->caption->description->text;
...
//echo "lightbox() is " . $this->settings->get($this->gallery, $field);
    ...
    public function has_link_to_image()
    {
    ...
    public function get_link()
    {
        ...
        if($this->has_lightbox()) {
            return plugins_url('../public/mthumb.php', __FILE__ )  . "?w=" . $this->gallery['lightbox_max_size'] . "&"
                                                        . "?h=" . $this->gallery['lightbox_max_size'] . "&"
                                                        . "src=" . $this->image->url;
        }
    }
