            ...
            <tr>
                <td>
					...
					<div class="row-actions">
						...
						<span class="clone"><a href="?page=<?php echo $this->plugin_name ?>-dashboard&amp;action=clone&amp;id=<?php echo $g->id ?>" data-id="<?php echo $g->id ?>" aria-label="Clone">Clone</a> | </span>
						<span class="trash"><a href="?page=<?php echo $this->plugin_name ?>-dashboard&amp;action=delete&amp;id=<?php echo $g->id ?>" data-id="<?php echo $g->id ?>" class="submitdelete" aria-label="Delete">Delete</a></span>
					</div>
				</td>
